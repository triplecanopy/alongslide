(function() {
  window.FixedAspect = (function() {
    ...
    FixedAspect.prototype.fitFrame = function(minWidthPx, marginTopPx) {
      var FRAME_ASPECT, FRAME_SELECTOR, frameAspect, frameWidthPx, marginTop, scalar, scaleDown, scaleUp, textStyles, window_aspect;
      if (marginTopPx == null) {
        marginTopPx = 0;
      }
      FRAME_ASPECT = 1.6;
    ...
    FixedAspect.prototype.fitPanels = function(frameAspect) {
      return $('#frames > .panels > .panel').each((function(_this) {
